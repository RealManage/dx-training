...
As a developer, you've built skills, agents, and hooks in previous weeks. Now you need to:
...
- The plugin.json manifest (optional — auto-discovers components)
- Packaging skills, agents, and hooks together

### Part 2: Skills in Plugins (30 min)

- Skills and commands (merged — same functionality, skills recommended)
